worker_processes 1
working_directory '/var/www/etlocal/current'
...
listen '/var/www/etlocal/shared/tmp/sockets/unicorn.sock', backlog: 64

# File containing the Unicorn process ID.
pid '/var/www/etlocal/shared/tmp/pids/unicorn.pid'

# Set the path of the log files inside the log folder of the testapp
stderr_path '/var/www/etlocal/shared/log/unicorn.log'
stdout_path '/var/www/etlocal/shared/log/unicorn.log'
...
before_fork do |server, worker|
  ...
  # end the old process...
  old_pid = '/var/www/etlocal/shared/tmp/pids/unicorn.pid.oldbin'
...
before_exec do |server|
  ENV["BUNDLE_GEMFILE"] = "/var/www/etlocal/current/Gemfile"
end
