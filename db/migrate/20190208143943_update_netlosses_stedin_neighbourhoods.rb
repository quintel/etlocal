class UpdateNetlossesStedinNeighbourhoods < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20190208143943_update_netlosses_stedin_neighbourhoods')
