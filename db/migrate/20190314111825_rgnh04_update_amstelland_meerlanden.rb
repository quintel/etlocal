class Rgnh04UpdateAmstellandMeerlanden < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20190314111825_rgnh04_update_amstelland_meerlanden')
