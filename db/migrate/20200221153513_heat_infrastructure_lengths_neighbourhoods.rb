class HeatInfrastructureLengthsNeighbourhoods < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20200221153513_heat_infrastructure_lengths_neighbourhoods')
