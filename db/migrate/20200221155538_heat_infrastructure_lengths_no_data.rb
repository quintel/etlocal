class HeatInfrastructureLengthsNoData < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20200221155538_heat_infrastructure_lengths_no_data')
