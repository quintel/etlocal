class HollandRijnlandGemeenten2017Step2 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20200303201350_holland_rijnland_gemeenten_2017_step_2')
