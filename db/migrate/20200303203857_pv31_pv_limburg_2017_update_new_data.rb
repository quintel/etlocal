class Pv31PvLimburg2017UpdateNewData < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20200303203857_pv31_pv_limburg_2017_update_new_data')
