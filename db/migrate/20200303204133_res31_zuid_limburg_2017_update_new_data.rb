class Res31ZuidLimburg2017UpdateNewData < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20200303204133_res31_zuid_limburg_2017_update_new_data')
