class UpdateFlevoMunicipalities2017Step1 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20200421142619_update_flevo_municipalities_2017_step_1')
