class UpdateFlevoMunicipalities2017Step2 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20200421142625_update_flevo_municipalities_2017_step_2')
