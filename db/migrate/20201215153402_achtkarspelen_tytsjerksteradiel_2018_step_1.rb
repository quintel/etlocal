class AchtkarspelenTytsjerksteradiel2018Step1 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20201215153402_achtkarspelen_tytsjerksteradiel_2018_step_1')
