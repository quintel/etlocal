class GelderlandResRoofSurfacesUpdate < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20210325125548_gelderland_res_roof_surfaces_update')
