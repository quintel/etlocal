class AddNewGhgDataToAll2018Regions < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20210419152925_add_new_ghg_data_to_all_2018_regions')
