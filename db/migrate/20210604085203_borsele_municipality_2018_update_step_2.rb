class BorseleMunicipality2018UpdateStep2 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20210604085203_borsele_municipality_2018_update_step_2')
