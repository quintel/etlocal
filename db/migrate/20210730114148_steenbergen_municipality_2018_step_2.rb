class SteenbergenMunicipality2018Step2 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20210730114148_steenbergen_municipality_2018_step_2')
