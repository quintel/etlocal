class LangedijkMunicipality2018UpdateStep1 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20210816065711_langedijk_municipality_2018_update_step_1')
