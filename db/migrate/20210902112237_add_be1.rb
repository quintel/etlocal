class AddMixers < ActiveRecord::Migration[5.0]
  def self.up
<<<<<<< HEAD:db/migrate/20210818152434_add_mixers.rb
    directory    = Rails.root.join('db/migrate/20210818152434_add_mixers')
=======
    directory    = Rails.root.join('db/migrate/20210902112237_add_be1')
>>>>>>> fda3e37 (Generating datasets BE and DE 2):db/migrate/20210902112237_add_be1.rb
