class AddMissingEfficiencies < ActiveRecord::Migration[5.0]
  def self.up
<<<<<<< HEAD:db/migrate/20210818154529_add_missing_efficiencies.rb
    directory    = Rails.root.join('db/migrate/20210818154529_add_missing_efficiencies')
=======
    directory    = Rails.root.join('db/migrate/20210902112246_add_be2')
>>>>>>> fda3e37 (Generating datasets BE and DE 2):db/migrate/20210902112246_add_be2.rb
