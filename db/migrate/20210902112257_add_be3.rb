class ExampleRegions < ActiveRecord::Migration[5.0]
  def self.up
<<<<<<< HEAD:db/migrate/20210818141933_example_regions.rb
    directory    = Rails.root.join('db/migrate/20210818141933_example_regions')
=======
    directory    = Rails.root.join('db/migrate/20210902112257_add_be3')
>>>>>>> fda3e37 (Generating datasets BE and DE 2):db/migrate/20210902112257_add_be3.rb
