class SteelInputs < ActiveRecord::Migration[5.2]
  ...
  UNSCALABLE_STEEL_KEYS = {
    ...
    industry_final_demand_for_metal_steel_electricity_industry_steel_blastfurnace_bof_parent_share: { nl2015: 0.987, nl: 1.0},
    industry_final_demand_for_metal_steel_network_gas_industry_steel_blastfurnace_bof_parent_share: { nl2015: 0.971, nl: 1.0},
    industry_final_demand_for_metal_steel_coal_industry_steel_blastfurnace_bof_parent_share: { nl2015: 0.963, nl: 1.0},
