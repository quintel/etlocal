class SteelInputs < ActiveRecord::Migration[5.2]
  ...
  # V(energy_cokesoven_own_use, input_of_coal)/MILLIONS,
  # V(energy_cokesoven_own_use, input_of_cokes)/MILLIONS,
  # V(energy_cokesoven_own_use, input_of_coal_gas)/MILLIONS,
  # V(energy_cokesoven_own_use, input_of_electricity)/MILLIONS,
  # V(energy_cokesoven_own_use, input_of_network_gas)/MILLIONS,
  # V(energy_cokesoven_own_use, input_of_steam_hot_water)/MILLIONS,
  # V(energy_cokesoven_own_use, input_of_crude_oil)/MILLIONS,
  ...
  # V(energy_blastfurnace_own_use, input_of_coal)/MILLIONS,
  # V(energy_blastfurnace_own_use, input_of_cokes)/MILLIONS,
  # V(energy_blastfurnace_own_use, input_of_coal_gas)/MILLIONS,
  # V(energy_blastfurnace_own_use, input_of_electricity)/MILLIONS,
  # V(energy_blastfurnace_own_use, input_of_network_gas)/MILLIONS,
  # V(energy_blastfurnace_own_use, input_of_steam_hot_water)/MILLIONS,
  # V(energy_blastfurnace_own_use, input_of_crude_oil)/MILLIONS,
  ...
  SCALABLE_STEEL_KEYS = {
    ...
    input_industry_metal_steel_coal_gas_demand: { nl2015: 19180.399999999983, nl: 19276.11093399994},
    input_industry_metal_steel_electricity_demand: { nl2015: 9458.899999999981, nl: 8862.115823999962},
    ...
    input_energy_cokesoven_own_use_electricity: { nl2015: 324.0600000000002, nl: 324.43513199999944},
