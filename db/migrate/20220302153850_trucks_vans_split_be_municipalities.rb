class TrucksVansSplitBeMunicipalities < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20220302153850_trucks_vans_split_be_municipalities')
