class AgricultureChpsNlCombinedDatasets2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20221223141812_agriculture_chps_nl_combined_datasets_2019')
