class LocalDatasetsBeDkUkNumberOfVansTrucksBusses < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20230109103539_local_datasets_be_dk_uk_number_of_vans_trucks_busses')
