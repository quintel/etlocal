class CustomRegionNumberOfVansBussesTrucks < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20230109130606_custom_region_number_of_vans_busses_trucks')
