class RgdsDrechtstedenDrechtsteden2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20230406143334_rgds_drechtsteden_drechtsteden2019')
