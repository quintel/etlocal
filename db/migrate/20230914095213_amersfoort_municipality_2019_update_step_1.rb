class AmersfoortMunicipality2019UpdateStep1 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20230914095213_amersfoort_municipality_2019_update_step_1')
