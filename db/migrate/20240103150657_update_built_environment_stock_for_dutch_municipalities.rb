class UpdateBuiltEnvironmentStockForDutchMunicipalities < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240103150657_update_built_environment_stock_for_dutch_municipalities')
