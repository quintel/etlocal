class UpdateBuiltEnvironmentStockForEfate < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240110111612_update_built_environment_stock_for_efate')
