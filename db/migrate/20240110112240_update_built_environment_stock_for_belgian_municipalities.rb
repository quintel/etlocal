class UpdateBuiltEnvironmentStockForBelgianMunicipalities < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240110112240_update_built_environment_stock_for_belgian_municipalities')
