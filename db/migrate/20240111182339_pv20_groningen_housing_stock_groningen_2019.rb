class Pv20GroningenHousingStockGroningen2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111182339_pv20_groningen_housing_stock_groningen_2019')
