class Pv25GelderlandHousingStockGelderland2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111182421_pv25_gelderland_housing_stock_gelderland_2019')
