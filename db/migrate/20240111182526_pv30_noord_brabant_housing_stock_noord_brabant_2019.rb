class Pv30NoordBrabantHousingStockNoordBrabant2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111182526_pv30_noord_brabant_housing_stock_noord_brabant_2019')
