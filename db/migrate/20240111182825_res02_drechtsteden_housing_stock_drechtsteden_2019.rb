class Res02DrechtstedenHousingStockDrechtsteden2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111182825_res02_drechtsteden_housing_stock_drechtsteden_2019')
