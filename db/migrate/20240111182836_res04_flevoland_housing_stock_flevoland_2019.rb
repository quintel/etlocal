class Res04FlevolandHousingStockFlevoland2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111182836_res04_flevoland_housing_stock_flevoland_2019')
