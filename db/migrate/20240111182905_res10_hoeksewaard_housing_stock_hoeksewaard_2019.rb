class Res10HoeksewaardHousingStockHoeksewaard2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111182905_res10_hoeksewaard_housing_stock_hoeksewaard_2019')
