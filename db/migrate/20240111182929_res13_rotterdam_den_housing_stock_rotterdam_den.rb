class Res13RotterdamDenHousingStockRotterdamDen < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111182929_res13_rotterdam_den_housing_stock_rotterdam_den')
