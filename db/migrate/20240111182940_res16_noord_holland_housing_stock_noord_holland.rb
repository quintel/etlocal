class Res16NoordHollandHousingStockNoordHolland < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111182940_res16_noord_holland_housing_stock_noord_holland')
