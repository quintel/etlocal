class Res17NoordHollandHousingStockNoordHolland < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111182950_res17_noord_holland_housing_stock_noord_holland')
