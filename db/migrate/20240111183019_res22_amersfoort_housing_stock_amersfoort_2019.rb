class Res22AmersfoortHousingStockAmersfoort2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111183019_res22_amersfoort_housing_stock_amersfoort_2019')
