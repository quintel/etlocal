class Res26CleantechHousingStockCleantech < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240111183042_res26_cleantech_housing_stock_cleantech')
