class UpdatePropaneEmissionFactorNorthernIreland < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240223114314_update_propane_emission_factor_northern_ireland')
