class RerunFutureTypicalHeatDemandEu < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240402111724_rerun_future_typical_heat_demand_eu')
