class Res11HrUpdatePvRoofSurfaceArea < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20240606101542_res11_hr_update_pv_roof_surface_area')
