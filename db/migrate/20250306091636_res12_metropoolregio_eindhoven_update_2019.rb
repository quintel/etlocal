class Res12MetropoolregioEindhovenUpdate2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20250306091636_res12_metropoolregio_eindhoven_update_2019')
