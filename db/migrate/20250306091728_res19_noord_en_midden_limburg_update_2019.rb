class Res19NoordEnMiddenLimburgUpdate2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20250306091728_res19_noord_en_midden_limburg_update_2019')
