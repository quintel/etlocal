class Res17NoordHollandZuidUpdate2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20250318083957_res17_noord_holland_zuid_update_2019')
