class Res20NoordOostBrabantUpdate2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20250318084000_res20_noord_oost_brabant_update_2019')
