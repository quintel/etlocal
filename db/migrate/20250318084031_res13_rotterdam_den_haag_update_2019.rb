class Res13RotterdamDenHaagUpdate2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20250318084031_res13_rotterdam_den_haag_update_2019')
