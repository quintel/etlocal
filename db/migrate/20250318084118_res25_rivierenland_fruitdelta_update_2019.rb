class Res25RivierenlandFruitdeltaUpdate2019 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20250318084118_res25_rivierenland_fruitdelta_update_2019')
