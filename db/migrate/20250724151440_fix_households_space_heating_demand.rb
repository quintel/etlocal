class FixHouseholdsSpaceHeatingDemand < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20250724151440_fix_households_space_heating_demand')
