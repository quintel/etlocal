class FixHouseholdsSpaceHeatingDemandPart2 < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20250725142028_fix_households_space_heating_demand_part_2')
