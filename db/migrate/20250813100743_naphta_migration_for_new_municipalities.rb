class NaphtaMigrationForNewMunicipalities < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20250813100743_naphta_migration_for_new_municipalities')
