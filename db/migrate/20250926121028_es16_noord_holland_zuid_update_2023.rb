class Es16NoordHollandZuidUpdate2023 < ActiveRecord::Migration[5.0]
  def self.up
    return

    directory    = Rails.root.join('db/migrate/202509261210285_es16_noord_holland_zuid_update_2023')
