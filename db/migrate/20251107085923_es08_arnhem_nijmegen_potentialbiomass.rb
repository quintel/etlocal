class Es08ArnhemNijmegenPotentialbiomass < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20251107085923_es08_arnhem_nijmegen_potentialbiomass')
