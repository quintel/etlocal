class Es22MiddenHollandPotentialbiomass < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20251107085946_es22_midden_holland_potentialbiomass')
