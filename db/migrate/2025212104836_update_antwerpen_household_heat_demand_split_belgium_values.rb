class UpdateAntwerpenHouseholdHeatDemandSplitBelgiumValues < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20250212104836_update_antwerpen_household_heat_demand_split_belgium_values')
