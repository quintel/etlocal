class Es08ArnhemNijmegenHeatPumpUpdate < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20260821153701_es08_arnhem_nijmegen_heat_pump_update')
