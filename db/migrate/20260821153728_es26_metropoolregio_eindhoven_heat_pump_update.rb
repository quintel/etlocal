class Es26MetropoolregioEindhovenHeatPumpUpdate < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20260821153728_es26_metropoolregio_eindhoven_heat_pump_update')
