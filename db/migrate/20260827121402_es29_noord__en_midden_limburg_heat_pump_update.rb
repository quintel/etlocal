class Es29NoordEnMiddenLimburgHeatPumpUpdate < ActiveRecord::Migration[5.0]
  def self.up
    directory    = Rails.root.join('db/migrate/20260827121402_es29_noord__en_midden_limburg_heat_pump_update')
