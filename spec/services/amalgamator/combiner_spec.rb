...
# RSpec.describe Amalgamator::Combiner do
...
#     # We test the arguments quite extensively since the Amalgamator is a service class
...
#       before do
#         allow_any_instance_of(Amalgamator::DatasetExporter).to receive(:perform).and_return(true)
#       end
...
#       it 'calls the Amalgamator::Combiner with the correct initialized datasets' do
#         expect(
...
#       it 'calls the Amalgamator::DatasetExporter with the correct attributes' do
#         allow_any_instance_of(Amalgamator::DatasetExporter).to receive(:perform).and_return(true)
